...
\addtofrontsidebar{
	\profilesection{Primárně}
		\skill{\faLaptopCode}{Python 2/3}
		\skill{\faCode}{Javascript, Typescript}
		\skill{\faDatabase}{SQL}

	\profilesection{Sekundárně}
		\skill{\faBalanceScale}{Linux, Docker, Git}
		\skill{\faSitemap}{C/C++, PHP}
	...
	\profilesection{O mně}
		\aboutme{
			...
			zajímá se o své okolí a je vegan. Jako dobrovolník se věnuje práci s dětmi a mládeží, organizaci tábora
...
\begin{cvtable}[2]
	\vspace{10pt}
	\cvitem{2019 -- \textit{2022}}{Magisterské studium}{FIT VUT v Brně}
	...
	\cvitem{}{Bakalářská práce}{Ústav inteligentních systémů}{Koordinace IoT na bázi MicroPythonu pomocí Node-RED}
...
\begin{cvtable}[2]
	\cvitem{2017 -- dosud}{\href{https://rytirskytabor.cz/}{Rytířský tábor}}{Sarkander z.s.}{
	...
	\cvitem{2013 -- dosud}{\href{https://minicup.tatranlitovel.cz/}{Litovel MINICUP} -- hlavní organizátor}{Tatran Litovel}{
	...
	\cvitem{12/2019 -- 06/2020}{Člen a fotograf}{ESN Riga}{
	...
	\cvitem{08/2015 -- 06/2016}{Trenér házené -- mládež}{Tatran Litovel}{
		Poznatky ze své hráčské a rozhodcovské kariéry jsem celou po sezónu předával mladým házenkářům ve věku 6-8 let.
	}
\end{cvtable}
