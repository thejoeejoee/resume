...
\begin{cvtable}[2]
	...
	\begin{itemize}
		\setlength\itemsep{0pt}
		\item development of internal component framework
...
\begin{cvtable}[2]
	...
	\begin{description}
		\setlength\itemsep{0pt}
		\item[Master degree] Information Technology and Artificial Intelligence -- Computer Networks (not finished)
		\item[ERASMUS+] {\small(08/2019-06/2020)}\\ University of Latvia, Faculty of Computing
		\item[Bachelor degree] Information Technology
 -- bachelor thesis \href{https://www.fit.vut.cz/study/thesis/21632/.en}{Coordination of MicroPython-Based IoT by Means of Node-RED}
	...
	\cvitem{2012 -- 2016}{High Electrical School}{Olomouc}
		{graduation thesis: \href{https://github.com/spseol/pybots-server/releases/download/v1.0/docs.pdf}{Virtual robots combats}}
\end{cvtable}
...
\begin{cvtable}[2]
	...
	\begin{description}
		...
		\item[Knowledge Manager] {\small(09/20-05/21)} -- knowledge management in section's Google Drive
	\end{description}
	}
	\vspace{-\baselineskip}
	...
	\begin{itemize}
		\setlength\itemsep{0pt}
		\item leading technical team for handball tournament
