...
\begin{cvtable}[2]
	\cvitem{2022 -- }{Python Developer}{\href{https://o.seznam.cz/}{Seznam.cz}}{
		...
		\begin{itemize}
			...
			\item team of internal CDN, especially IPTV solution for Seznam
			\item HW video encoding controlled by Python, deployed to k8s clusters
			\item low-level adjustments of media containers and codecs
			\item Kubernetes operators for high availability
		\end{itemize}
	}
